// The MIT License (MIT)
// QrSDKmalistic CSV Streams 1.8.7
...
// version 1.8.1  : Put under the QrSDK namespace
	...
	namespace QrCSV
	{
		...
		public:
			std::string error_line(const std::string& token, const std::string& function_site)
			{
				...
				is << "QrCSV::istream_base Conversion error at line no.:" << line_num
...
template<typename T>
QrSDK::QrCSV::ifstream& operator >> (QrSDK::QrCSV::ifstream& istm, T& val)
{
...
template<>
inline QrSDK::QrCSV::ifstream& operator >> (QrSDK::QrCSV::ifstream& istm, std::string& val)
{
...
template<>
inline QrSDK::QrCSV::ifstream& operator >> (QrSDK::QrCSV::ifstream& istm, QrSDK::QrCSV::sep& val)
{
...
inline QrSDK::QrCSV::ifstream& operator >> (QrSDK::QrCSV::ifstream& istm, QrSDK::QrCSV::NChar val)
{
	const std::string& str = istm.get_delimited_str();
...
template<>
inline QrSDK::QrCSV::ifstream& operator >> (QrSDK::QrCSV::ifstream& istm, char& val)
{
...
template<typename T>
QrSDK::QrCSV::ofstream& operator << (QrSDK::QrCSV::ofstream& ostm, const T& val)
{
...
template<>
inline QrSDK::QrCSV::ofstream& operator << (QrSDK::QrCSV::ofstream& ostm, const std::string& val)
{
	if (!ostm.get_after_newline())
		ostm.get_ofstream() << ostm.get_delimiter();
...
template<>
inline QrSDK::QrCSV::ofstream& operator << (QrSDK::QrCSV::ofstream& ostm, const QrSDK::QrCSV::sep& val)
{
...
template<>
inline QrSDK::QrCSV::ofstream& operator << (QrSDK::QrCSV::ofstream& ostm, const char& val)
{
	if (val == NEWLINE)
	{
...
inline QrSDK::QrCSV::ofstream& operator << (QrSDK::QrCSV::ofstream& ostm, QrSDK::QrCSV::NChar val)
{
	if (!ostm.get_after_newline())
		ostm.get_ofstream() << ostm.get_delimiter();
...
inline QrSDK::QrCSV::ofstream& operator << (QrSDK::QrCSV::ofstream& ostm, const float val)
{
	if (!ostm.get_after_newline())
		ostm.get_ofstream() << ostm.get_delimiter();
...
inline QrSDK::QrCSV::ofstream& operator << (QrSDK::QrCSV::ofstream& ostm, const double val)
{
	if (!ostm.get_after_newline())
		ostm.get_ofstream() << ostm.get_delimiter();
...
inline QrSDK::QrCSV::ofstream& operator << (QrSDK::QrCSV::ofstream& ostm, const long double val)
{
	if (!ostm.get_after_newline())
		ostm.get_ofstream() << ostm.get_delimiter();
...
template<typename T>
QrSDK::QrCSV::istringstream& operator >> (QrSDK::QrCSV::istringstream& istm, T& val)
{
	const std::string& str = istm.get_delimited_str();
...
template<>
inline QrSDK::QrCSV::istringstream& operator >> (QrSDK::QrCSV::istringstream& istm, std::string& val)
{
	val = istm.get_delimited_str();
...
template<>
inline QrSDK::QrCSV::istringstream& operator >> (QrSDK::QrCSV::istringstream& istm, QrSDK::QrCSV::sep& val)
{
	istm.set_delimiter(val.get_delimiter(), val.get_escape());
...
inline QrSDK::QrCSV::istringstream& operator >> (QrSDK::QrCSV::istringstream& istm, QrSDK::QrCSV::NChar val)
{
	const std::string& str = istm.get_delimited_str();
...
template<>
inline QrSDK::QrCSV::istringstream& operator >> (QrSDK::QrCSV::istringstream& istm, char& val)
{
	const std::string& src = istm.get_delimited_str();
...
template<typename T>
QrSDK::QrCSV::ostringstream& operator << (QrSDK::QrCSV::ostringstream& ostm, const T& val)
{
	if (!ostm.get_after_newline())
...
template<>
inline QrSDK::QrCSV::ostringstream& operator << (QrSDK::QrCSV::ostringstream& ostm, const std::string& val)
{
	if (!ostm.get_after_newline())
		ostm.get_ostringstream() << ostm.get_delimiter();
...
template<>
inline QrSDK::QrCSV::ostringstream& operator << (QrSDK::QrCSV::ostringstream& ostm, const QrSDK::QrCSV::sep& val)
{
	ostm.set_delimiter(val.get_delimiter(), val.get_escape());
...
template<>
inline QrSDK::QrCSV::ostringstream& operator << (QrSDK::QrCSV::ostringstream& ostm, const char& val)
{
	if (val == NEWLINE)
	{
...
inline QrSDK::QrCSV::ostringstream& operator << (QrSDK::QrCSV::ostringstream& ostm, QrSDK::QrCSV::NChar val)
{
	if (!ostm.get_after_newline())
		ostm.get_ostringstream() << ostm.get_delimiter();
...
inline QrSDK::QrCSV::ostringstream& operator << (QrSDK::QrCSV::ostringstream& ostm, const float val)
{
	if (!ostm.get_after_newline())
		ostm.get_ostringstream() << ostm.get_delimiter();
...
inline QrSDK::QrCSV::ostringstream& operator << (QrSDK::QrCSV::ostringstream& ostm, const double val)
{
	if (!ostm.get_after_newline())
		ostm.get_ostringstream() << ostm.get_delimiter();
...
inline QrSDK::QrCSV::ostringstream& operator << (QrSDK::QrCSV::ostringstream& ostm, const long double val)
{
	if (!ostm.get_after_newline())
		ostm.get_ostringstream() << ostm.get_delimiter();
